...
curl -s "https://s3.amazonaws.com/ec2-linux-nvidia-drivers/latest/?delimiter=/"
chmod +x NVIDIA-Linux-x86_64*.run
sudo /bin/sh ./NVIDIA-Linux-x86_64*.run -e --silent --no-questions --accept-license --no-cc-version-check
nvidia-smi -q | head
